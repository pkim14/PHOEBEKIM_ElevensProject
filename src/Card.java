...
public class Card {
    ...
    public static void replaceCard(ArrayList<Card> deck, ArrayList<Card> hand, int index) {
    ...
    public static ArrayList<Card> replacedCard(ArrayList<Card> deck, ArrayList<Card> hand, int index) {
        ArrayList<Card> temp = new ArrayList<>();
